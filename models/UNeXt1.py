...
class UNext(nn.Module):
    ...
    def __init__(self,  num_classes=3, input_channels=3, deep_supervision=False,img_size=256, patch_size=16, in_chans=3,  embed_dims=[ 128, 160, 256],
        ...
        ############ 128, 32, 32             
        self.mem_rep1_0 = MemModule_window(mem_dim=mem_dim, fea_dim=128*4*4, window=4,shrink_thres =shrink_thres)
        self.mem_rep1_1 = MemModule_window(mem_dim=mem_dim, fea_dim=128*8, window=8,c_size=8,shrink_thres =shrink_thres)
        self.mem_rep1_2 = MemModule1_new(mem_dim=mem_dim, fea_dim=1024,window=1, shrink_thres =shrink_thres)
        ############32, 64, 64                       
        self.mem_rep0_0 = MemModule_window(mem_dim=mem_dim, fea_dim=32*8*8, window=8,shrink_thres =shrink_thres)
        self.mem_rep0_1 = MemModule_window(mem_dim=mem_dim, fea_dim=32*16*2, window=16,c_size=8,shrink_thres =shrink_thres)
    
        self.mem_rep0_2 = MemModule1_new(mem_dim=mem_dim, fea_dim=1024,window=2, shrink_thres =shrink_thres)
    ############ 16, 128, 128
        self.mem_rep_0 = MemModule_window(mem_dim=mem_dim, fea_dim=16*16*4, window=16,c_size=4,shrink_thres =shrink_thres)
        self.mem_rep_1 = MemModule_window(mem_dim=mem_dim, fea_dim=16*64, window=32,c_size=16,shrink_thres =shrink_thres)
