...
# #         self.conv3 = double_conv(base_channels*32,base_channels*16)
#         self.mem_rep2 = MemModule_w(mem_dim=mem_dim, fea_dim=base_channels*8*2*2, 
#                                     shrink_thres =0.0025,window_size=2)
...
#         self.mem_rep1 =  MemModule_w(mem_dim=mem_dim, fea_dim=base_channels*4*4*4, 
#                                     shrink_thres =0.0025,window_size=4)
#         self.mem_rep1_ = MemModule1(mem_dim=mem_dim, fea_dim=1024, shrink_thres =shrink_thres)
#         self.conv1 = double_conv(base_channels*8,base_channels*4)
        
#         self.mem_rep0 = MemModule_w(mem_dim=mem_dim, fea_dim=base_channels*2*4*4, 
#                                     shrink_thres =0.0025,window_size=4)
#         self.mem_rep0_ = MemModule1(mem_dim=mem_dim, fea_dim=4096, shrink_thres =shrink_thres)
#         self.conv0 = double_conv(base_channels*4,base_channels*2)
        ...
        self.mem_rep1 =  MemModule_w(mem_dim=mem_dim, fea_dim=base_channels*4*2*2, 
                                    shrink_thres =0.0025,window_size=2)
        self.mem_rep1_ = MemModule1(mem_dim=mem_dim, fea_dim=1024, shrink_thres =shrink_thres)
        self.conv1 = double_conv(base_channels*8,base_channels*4)
...
#         self.conv0 = double_conv(base_channels*4,base_channels*2)
#         self.mem_rep0_ = MemModule_w(mem_dim=mem_dim, fea_dim=base_channels*4*4, 
#                                     shrink_thres =0.0085,window_size=4)
...
#         print(x.shape)
        return x,att3,att3_,att2,att2_,att1,att1_,att0,att0_
...
#         opt.imageSize, opt.nz, opt.nc, opt.ngf, opt.ngpu, opt.n_extra_layers
    ...
    def forward(self, x):
        gen_imag,att3,att3_,att2,att2_,att1,att1_,att0,att0_= self.encoder1(x)
        return gen_imag,att3,att3_,att2,att2_,att1,att1_,att0,att0_
