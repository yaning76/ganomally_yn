...
#         self.conv3 = double_conv(base_channels*32,base_channels*16)
        self.mem_rep2 = MemModule(mem_dim=mem_dim, fea_dim=base_channels*8, shrink_thres =0.0025)
        ...
        self.mem_rep1 = MemModule(mem_dim=mem_dim, fea_dim=base_channels*4, shrink_thres =0.0035)
        self.mem_rep1_ = MemModule1(mem_dim=mem_dim, fea_dim=1024, shrink_thres =0.0035)
...
#         self.conv0 = double_conv(base_channels*4,base_channels*2)
        self.mem_rep0_ = MemModule_w(mem_dim=mem_dim, fea_dim=base_channels*4*4, 
                                    shrink_thres =0.01,window_size=4)
