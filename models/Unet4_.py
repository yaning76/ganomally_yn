...
#         self.conv3 = double_conv(base_channels*32,base_channels*16)
        ...
        self.mem_rep0 = MemModule(mem_dim=mem_dim, fea_dim=base_channels*2, 
...
#         opt.imageSize, opt.nz, opt.nc, opt.ngf, opt.ngpu, opt.n_extra_layers
    ...
    def forward(self, x):
        gen_imag,att3,att2,att1,att0= self.encoder1(x)
        return gen_imag,att3,att2,att1,att0
