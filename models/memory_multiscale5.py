...
#         print(input.shape)
        ...
        res.append(res2_0)
        x = torch.cat([res2_0['output'],out3], dim=1)
        x = self.pyramid0_D(x)
        
        res1_0=self.mem_rep1_0(x)
        res.append(res1_0)
        x = torch.cat([res1_0['output'],out2], dim=1)
        x=self.pyramid1_D(x)
        
        res0_0=self.mem_rep0_0(out1)
        res.append(res0_0)
        x = torch.cat([res0_0['output'],out1], dim=1)
        x = self.pyramid2_D(x)
        
        res_0=self.mem_rep_0(out0)
        res.append(res_0)
        x=self.pyramid3_D(res_0['output'])
