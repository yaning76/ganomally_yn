...
#         self.conv2 = double_conv(base_channels*16,base_channels*8)
        self.conv2_ = double_conv(base_channels*24,base_channels*8)
...
#         print(x.shape)
        return x,att3,att3_,att2,att2_
...
#         opt.imageSize, opt.nz, opt.nc, opt.ngf, opt.ngpu, opt.n_extra_layers
    ...
    def forward(self, x):
        gen_imag,att3,att3_,att2,att2_= self.encoder1(x)
        return gen_imag,att3,att3_,att2,att2_
