...
class Encoder(nn.Module):
    ...
    def __init__(self, imageSize=128, nc=3, ngf=64, ngpu=1, n_extra_layers=0, add_final_conv=True):
...
#         opt.imageSize, opt.nz, opt.nc, opt.ngf, opt.ngpu, opt.n_extra_layers
        self.encoder1 = Encoder(opt.imageSize, opt.nc, opt.ngf, opt.ngpu, opt.n_extra_layers)
    def forward(self, x):
