...
from models.SCADN2 import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_SCADN2_16_1", help="path to save experiments results")
