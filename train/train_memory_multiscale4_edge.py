...
parser.add_argument("--experiment", default=r"../experiments/train_memory_multiscale4_transistor_edge", help="path to save experiments results")
...
# parser = argparse.ArgumentParser()
# parser.add_argument("--experiment", default=r"../experiments/train_memory_multiscale4_cable_edge", help="path to save experiments results")
