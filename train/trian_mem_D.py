...
parser.add_argument("--experiment", default=r"../experiments/train_memae_original_D_wood", help="path to save experiments results")
parser.add_argument("--dataset", default="wood", help="mnist")
