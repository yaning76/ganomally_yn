...
from models.Ganomaly_CoordinateSubstructure_Transformers_ import NetD, NetG
os.environ["CUDA_VISIBLE_DEVICES"] = '0'

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/skip_GANomaly_train_my_", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/skip_GANomaly_train_my/gen.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/skip_GANomaly_train_my/disc.pth", help="pretrained model of disc")
...
#                       L_total=L_total_epoch_loss, disc_loss=disc_epoch_loss)
        print('L_adv:{}, L_con:{}, L_lat:{}, L_total:{}, disc_loss:{}'.format(L_adv_gen_epoch_loss,L_con_epoch_loss,L_lat_epoch_loss,
                                                    L_total_epoch_loss,disc_epoch_loss))
