...
from models.Unet4_w2_add_tile import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Unet4_w2_add_tile__ssim_bigshrink", help="path to save experiments results")
parser.add_argument("--dataset", default="tile", help="mnist")
