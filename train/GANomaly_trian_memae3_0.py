...
from models.Unet import NetG,NetD

from models.SSIM import SSIM
parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Unet_M5_SSIM", help="path to save experiments results")
...
########################################################
        ...
        #torch.Size([32, 3, 128, 128]) torch.Size([32, 100, 1, 1]) torch.Size([32, 100, 1, 1])
            outputs,att1, att2,att3= gen(inputs)
...
#             l_en.append(enc_loss)
        ...
        entropy_loss_weight*(entropy_loss1+entropy_loss2+entropy_loss3)
            total_loss.backward()
...
# parser = argparse.ArgumentParser()
# parser.add_argument("--experiment", default=r"../experiments/train_Unet_grid", help="path to save experiments results")
