...
from models.Unet4_w2_add_cable import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Unet4_w2_add_cable__ssim_bigshrink_D", help="path to save experiments results")
