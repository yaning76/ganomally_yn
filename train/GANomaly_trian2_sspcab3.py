...
from models.Ganomaly_SSPCAB3 import NetG,NetD
# from models.NetD import NetD

# from models.DCGAN_GANomaly_ori import NetG,NetD

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Ganomaly_SSPCAB3_grid", help="path to save experiments results")
...
#             print(D_real.shape,label_real.shape)
            ...
            outputs, _, _, _,_,_,_,_,_,_,_= gen(inputs)#改
...
########################################################
        ...
        #torch.Size([32, 3, 128, 128]) torch.Size([32, 100, 1, 1]) torch.Size([32, 100, 1, 1])
            ...
            outputs, latent_in, latent_out,out0,out0_,out1,out1_,out2,out2_,out3,out3_ = gen(inputs)#改
...
#             print('latent_out, latent_in',latent_out.shape, latent_in.shape)
            ...
            sspcab_loss0=L_sspcab1(out0,out0_)#改
            sspcab_loss1=L_sspcab1(out1,out1_)#改
            sspcab_loss2=L_sspcab2(out2,out2_)#改
            sspcab_loss3=L_sspcab3(out3,out3_)#改
        
            b,c,h,w=inputs.shape
#             print(enc_loss/b)
            l_en.append(enc_loss)
    
            l_sspcab0.append(sspcab_loss0)#改
            l_sspcab1.append(sspcab_loss1)#改
            l_sspcab2.append(sspcab_loss2)#改
            l_sspcab3.append(sspcab_loss3)#改
        
            total_loss = opt.lambda_adv * adv_loss + \
                        opt.lambda_con * con_loss + \
                            opt.lambda_enc * enc_loss+0.01*(sspcab_loss0+sspcab_loss1+sspcab_loss2+sspcab_loss3)#改
            total_loss.backward()
            ...
            L_sspcab_epoch_loss0 += sspcab_loss0.item() * batch_size#改
...
#         print(enc_loss)
        ...
        L_sspcab_epoch_loss0 /= opt.dataSize#改
