...
parser.add_argument("--experiment", default=r"../experiments/train_mem5_unet_D_zipper", help="path to save experiments results")
parser.add_argument("--dataset", default="zipper", help="mnist")
