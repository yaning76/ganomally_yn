...
from models.unet import NetD, NetG

import os
os.environ["CUDA_VISIBLE_DEVICES"] = '4'

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/unet_train_transistor", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/unet_train/gen.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/unet_train/disc.pth", help="pretrained model of disc")
