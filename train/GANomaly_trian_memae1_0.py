...
from models.Ganomaly_MemAE1 import NetG,NetD

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_memae1_M5", help="path to save experiments results")
