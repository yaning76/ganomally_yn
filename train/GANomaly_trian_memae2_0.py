...
from models.Unet2_ import NetG,NetD

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Unet2__bottle", help="path to save experiments results")
...
#             l_en.append(enc_loss)
        ...
        entropy_loss_weight*(entropy_loss2+entropy_loss3)
            total_loss.backward()
