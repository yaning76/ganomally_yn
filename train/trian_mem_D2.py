...
from models.mem_unet_D import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_mem_unet_D_carpet", help="path to save experiments results")
parser.add_argument("--dataset", default="carpet", help="mnist")
