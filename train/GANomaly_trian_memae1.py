...
from models.Unet1_ import NetG,NetD

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Unet1__bottle", help="path to save experiments results")
...
#             print(D_real.shape,label_real.shape)
            disc_loss_real = L_adv_disc(D_real, label_real)#//
...
#         print(enc_loss)
        ...
        print('L_adv:{},L_con:{},L_lat_epoch_loss:{},L_tr_entropy_loss_func:{},L_total:{},disc_loss{}'.format(L_adv_gen_epoch_loss,L_con_epoch_loss,L_lat_epoch_loss,L_tr_entropy_loss_func,L_total_epoch_loss,disc_epoch_loss))
