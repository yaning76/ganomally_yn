...
parser.add_argument("--experiment", default=r"../experiments/train_ml_memAE_sc_bottle", help="path to save experiments results")
parser.add_argument("--dataset", default="bottle", help="mnist")
