...
from models.Unet4_w2_add_capsule3 import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Unet4_w2_add_capsule3__ssim_bigshrink_D", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/a/gen.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/a/disc.pth", help="pretrained model of disc")
...
#             print(D_real.shape,label_real.shape)
            ...
            outputs,_,_,_,_,_,_,_,_= gen(inputs)
#             print(outputs.shape)
...
########################################################
        ...
        #torch.Size([32, 3, 128, 128]) torch.Size([32, 100, 1, 1]) torch.Size([32, 100, 1, 1])
            outputs, att3,att3_,att2,att2_,att1,att1_,att0,att0_= gen(inputs)
...
#             l_en.append(enc_loss)
        ...
        entropy_loss_weight*(entropy_loss2+entropy_loss3+entropy_loss2_+entropy_loss3_+
                             entropy_loss1+entropy_loss1_+entropy_loss0+entropy_loss0_)
            total_loss.backward()
