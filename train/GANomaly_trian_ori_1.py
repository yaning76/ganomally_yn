...
from models.Ganomaly_z import NetD, NetG
import numpy as np
import os
...
parser.add_argument("--experiment", default=r"../experiments/train_Ganomaly_z_M2", help="path to save experiments results")
parser.add_argument("--dataset", default="MainboardScrew02", help="mnist")
...
# with range(opt.n_epoches) as t:
tolloss=10000
for e in range(opt.n_epoches):
#     t.set_description(f"Epoch {e+1} /{opt.n_epoches} Per epoch {train_dataset.__len__()}")
    print('Epoch:{}/{}'.format(e,opt.n_epoches))
