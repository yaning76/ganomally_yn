...
from models.memory_multiscale2 import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_memory_multiscale2_grid", help="path to save experiments results")
...
#             entropy_loss10 = tr_entropy_loss_func10(res[10]["att"])
            ...
            entropy_loss4+entropy_loss5+entropy_loss6+entropy_loss7
