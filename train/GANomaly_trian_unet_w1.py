...
from models.Unet4_w2_add_metal_nut1 import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_Unet4_w2_add_metal_nut1_ssim_bigshrink_D", help="path to save experiments results")
parser.add_argument("--dataset", default="metal_nut", help="mnist")
