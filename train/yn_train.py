...
import sys
sys.path.append("..")
from dataload.dataload_yn1 import load_dataset
...
parser.add_argument("--experiment", default=r"../experiments/train_SCADN1_32", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_SCADN1_32/gen.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_SCADN1_32/disc.pth", help="pretrained model of disc")
...
#         L_enc_epoch_loss = 0.0
        ...
        disc_epoch_loss = 0.0
#         l_en=[]
        for inputs, _, mask in train_dataloader:#x, y, mask
            
            inputs0 = inputs[0].to(device)
            inputs1 = inputs[1].to(device)
            batch_size = inputs0.size(0)
            
            mask = mask.to(device)#改
...
#         print(enc_loss)
        ...
        L_con_epoch_loss1 /= opt.dataSize
        ...
        print('L_adv:{},L_con:{},L_lat_epoch_loss:{},L_total:{},disc_loss{}'.format(L_adv_gen_epoch_loss,L_con_epoch_loss,L_lat_epoch_loss,L_total_epoch_loss,disc_epoch_loss))
