...
parser.add_argument("--experiment", default=r"../experiments/train_memae_original_D_screw", help="path to save experiments results")
parser.add_argument("--dataset", default="screw", help="mnist")
