...
from models.Ganomaly_CoordinateSubstructure_Transformers import NetD, NetG
os.environ["CUDA_VISIBLE_DEVICES"] = '0'

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/skip_GANomaly_train_my", help="path to save experiments results")
