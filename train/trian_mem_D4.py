...
from models.memae_original_D import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_memae_original_D_transistor", help="path to save experiments results")
...
#             l_en.append(enc_loss)
        ...
        entropy_loss_weight*entropy_loss0
            total_loss.backward()
