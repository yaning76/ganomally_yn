...
from models.mem5_unet_D import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_mem5_unet_D_transistor", help="path to save experiments results")
parser.add_argument("--dataset", default="transistor", help="mnist")
...
########################################################
        ...
        #torch.Size([32, 3, 128, 128]) torch.Size([32, 100, 1, 1]) torch.Size([32, 100, 1, 1])
            outputs,att3,att2,att1,att0= gen(inputs)
...
#             l_en.append(enc_loss)
        ...
        entropy_loss_weight*(entropy_loss0+entropy_loss1+entropy_loss2+entropy_loss3)
            total_loss.backward()
...
#         print(enc_loss)
        ...
        print('L_adv:{},L_con:{},L_lat_epoch_loss:{},L_tr_entropy_loss_func:{},L_total:{},disc_loss{}'.format(L_adv_gen_epoch_loss,L_con_epoch_loss,L_lat_epoch_loss,L_tr_entropy_loss_func0,L_total_epoch_loss,disc_epoch_loss))
