...
from models.UNeXt import NetG,NetD
from models.SSIM import SSIM

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/train_UNeXt_cable", help="path to save experiments results")
parser.add_argument("--dataset", default="cable", help="mnist")
parser.add_argument('--dataroot', default=r"../data/", help='path to dataset')
parser.add_argument("--n_epoches", type=int, default=1000, help="number of epoches of training")
...
#             print(feature_fake.shape)
            ...
            entropy_loss4+entropy_loss5+entropy_loss6+entropy_loss7+entropy_loss8+entropy_loss9+entropy_loss10
