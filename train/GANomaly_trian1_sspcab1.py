...
parser.add_argument("--experiment", default=r"../experiments/train_Ganomaly_SSPCAB1_M5", help="path to save experiments results")
...
########################################################
        ...
        #torch.Size([32, 3, 128, 128]) torch.Size([32, 100, 1, 1]) torch.Size([32, 100, 1, 1])
            ...
            outputs, latent_in, latent_out,out2,out2_,out3,out3_ = gen(inputs)#改
...
#             print(enc_loss/b)
            ...
            total_loss = opt.lambda_adv * adv_loss + \
                        ...
                        opt.lambda_enc * enc_loss+0.01*(sspcab_loss2+sspcab_loss3)#改
            total_loss.backward()
