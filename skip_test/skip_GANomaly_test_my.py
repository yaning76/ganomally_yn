...
from models.Ganomaly_CoordinateSubstructure_Transformers_ import NetG, NetD
from evaluate import Evaluate, draw_heatmap
os.environ["CUDA_VISIBLE_DEVICES"] = '0'


parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/skip_GAnomaly_test_my", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/skip_GANomaly_train_my_/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/skip_GANomaly_train_my_/disc_best.pth", help="pretrained model of disc")
