...
parser.add_argument("--experiment", default=r"../experiments/test_SCADN1_16", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_SCADN1_16/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_SCADN1_16/disc_best.pth", help="pretrained model of disc")
