...
parser.add_argument("--experiment", default=r"../experiments/test_Ganomaly_SSPCAB2_grid", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_Ganomaly_SSPCAB2_grid/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_Ganomaly_SSPCAB2_grid/disc_best.pth", help="pretrained model of disc")
