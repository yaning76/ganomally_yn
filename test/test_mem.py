...
from models.mem_unet import NetG,NetD
# from models.DCGAN_GANomaly_ori import NetG, NetD
#MainboardScrew05
parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/test_mem_screw", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_mem_screw/gen.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_mem_screw/disc.pth", help="pretrained model of disc")
...
print(con)
print(labels)
con = np.array(con_loss)
con = (con - np.min(con)) / (np.max(con) - np.min(con))
print('con_loss',con)
evaluation.labels = labels
evaluation.scores = con
##############
n=evaluation.run() 
