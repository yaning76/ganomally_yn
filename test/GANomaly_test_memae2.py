...
from models.Unet4_w2_add_leather import NetG,NetD
# from models.DCGAN_GANomaly_ori import NetG, NetD
#MainboardScrew05
parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/test_Unet4_w2_add_leather__ssim_bigshrink", help="path to save experiments results")
parser.add_argument("--dataset", default="leather", help="mnist")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_Unet4_w2_add_leather__ssim_bigshrink/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_Unet4_w2_add_leather__ssim_bigshrink/disc_best.pth", help="pretrained model of disc")
