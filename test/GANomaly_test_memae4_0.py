...
import sys
sys.path.append("..")
from dataload.dataload_edge import load_dataset
...
from models.memory_multiscale4 import NetG,NetD
# from models.DCGAN_GANomaly_ori import NetG, NetD
#MainboardScrew05
parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/test_memory_multiscale4_cable_edge", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_memory_multiscale4_cable/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_memory_multiscale4_cable/disc_best.pth", help="pretrained model of disc")
