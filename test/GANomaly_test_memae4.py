...
from models.memory_multiscale1_1 import NetG,NetD
# from models.DCGAN_GANomaly_ori import NetG, NetD
#MainboardScrew05
parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/test_memory_multiscale1_1_carpet", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_memory_multiscale1_1_carpet/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_memory_multiscale1_1_carpet/disc_best.pth", help="pretrained model of disc")
