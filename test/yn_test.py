...
parser.add_argument("--experiment", default=r"../experiments/test_SCADN_capsule", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_SCADN/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_SCADN/disc_best.pth", help="pretrained model of disc")
