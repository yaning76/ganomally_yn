...
from models.ganomaly_original import NetD, NetG
...
parser.add_argument("--experiment", default=r"../experiments/test_ganomaly_original_screw", help="path to save experiments results")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_ganomaly_original_screw/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_ganomaly_original_screw/disc_best.pth", help="pretrained model of disc")
