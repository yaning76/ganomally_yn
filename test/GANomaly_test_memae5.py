...
from models.swin1 import NetG,NetD
# from models.DCGAN_GANomaly_ori import NetG, NetD
#MainboardScrew05
parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/test_swin1_cable", help="path to save experiments results")
...
parser.add_argument("--size", type=int, default=224, help="size of image after scaled")
parser.add_argument("--imageSize", type=int, default=224, help="size of each image dimension")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_swin1_cable/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_swin1_cable/disc_best.pth", help="pretrained model of disc")
...
#         print(outputs.shape)
    ...
    for j in range(0,11):
        ...
        score=(con+ssim_loss)*lambda_L_con + lat*lambda_L_lat
