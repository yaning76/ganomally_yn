...
parser.add_argument("--experiment", default=r"../experiments/train", help="path to save experiments results")
parser.add_argument("--dataset", default="CPUScrew", help="mnist")
...
parser.add_argument("--gen_pth", default=r"../experiments/train/gen_99.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train/disc_99.pth", help="pretrained model of disc")
...
## dataset
test_dataset = load_dataset(opt.dataroot, opt.dataset, opt.size, trans=None, train=True)
