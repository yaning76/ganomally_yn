...
from models.Ganomaly_ACmix import NetG,NetD
# from models.GANomaly_transformer_ import NetG
# from models.NetD import NetD

parser = argparse.ArgumentParser()
parser.add_argument("--experiment", default=r"../experiments/test_Ganomaly_ACmix_M04_1000", help="path to save experiments results")
parser.add_argument("--dataset", default="MainboardScrew04", help="mnist")
...
parser.add_argument("--nz", type=int, default=1000, help="dimensionality of the latent space")
...
parser.add_argument("--gen_pth", default=r"../experiments/train_Ganomaly_ACmix_M04_1000/gen_best.pth", help="pretrained model of gen")
parser.add_argument("--disc_pth", default=r"../experiments/train_Ganomaly_ACmix_M04_1000/disc_best.pth", help="pretrained model of disc")
